...
On crée AdminUser, avec mdp crypté, on sauvegarde dans la DB et on choisit username comme identifiant
...
On voit dans src/Entity/AdminUser.php les champs créés par défaut
...
On y prend l'encodeur de symfony
...
Ensuite on charge les fixtures
